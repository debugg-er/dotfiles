...
s0_no_close_match = 
s0_no_focus_match = 
s0_size_matches = class=MintMenu.py;
s0_size_width_values = 0;
s0_size_height_values = 0;
...
s0_brightness_increase_key = <Alt>Prior
s0_brightness_increase_button = Disabled
s0_brightness_decrease_key = <Alt>Next
...
s0_fire_size = 7,000000
s0_fire_slowdown = 0,500000
s0_fire_life = 0,200000
...
[core]
s0_active_plugins = core;composite;opengl;compiztoolbox;copytex;decor;firepaint;grid;imgpng;matecompat;mousepoll;move;obs;regex;resize;snap;winrules;animation;commands;cube;expo;ezoom;staticswitcher;workarounds;
...
s0_outputs = 1366x768+0+0;1280x1024+1366+0;
